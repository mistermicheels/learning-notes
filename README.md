...
- [**architecture-design**](architecture-design/README.md)
    - [**architectural-boundaries**](architecture-design/architectural-boundaries/README.md)
        - [Architectural boundaries (overview)](architecture-design/architectural-boundaries/!-Architectural-boundaries.md)
        - [Boundaries and the database](architecture-design/architectural-boundaries/Boundaries-database.md)
        - [Boundaries and duplication](architecture-design/architectural-boundaries/Boundaries-duplication.md)
        - [Boundaries and libraries/frameworks](architecture-design/architectural-boundaries/Boundaries-libraries-frameworks.md)
        - [Boundaries and the web](architecture-design/architectural-boundaries/Boundaries-web.md)
        - [Horizontal versus vertical separation](architecture-design/architectural-boundaries/Horizontal-vertical-separation.md)
        - [Separation mechanisms](architecture-design/architectural-boundaries/Separation-mechanisms.md)
...
- [**java**](java/README.md)
    - [**concurrency**](java/concurrency/README.md)
        - [Concurrency (overview)](java/concurrency/!-Concurrency.md)
        - [Locking](java/concurrency/Locking.md)
        - [Thread safety](java/concurrency/Thread-safety.md)
        - [Threads](java/concurrency/Threads.md)
